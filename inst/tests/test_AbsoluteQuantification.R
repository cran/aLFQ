...
test_that("AbsoluteQuantification.default", {
	...
	data_abs<-AbsoluteQuantification.default(UPS2_SRM_REP,consensus_peptide=TRUE,consensus_transitions=TRUE)
	...
	data_absnc<-AbsoluteQuantification.default(UPS2_SRM_REP,consensus_peptide=FALSE,consensus_transitions=FALSE)
